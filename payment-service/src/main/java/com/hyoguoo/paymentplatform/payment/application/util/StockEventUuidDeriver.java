 ...
 *
 * <p>사용처: {@code PaymentConfirmResultUseCase.buildStockCommitOutbox} (stock-commit prefix).
 * 재고 복원(stock-restore) 경로는 폐기되어 사용처가 stock-commit 한 곳뿐이지만, prefix 인자를
 * 유지해 향후 추가 이벤트 종류 도입 시 같은 도출 규칙을 재사용할 수 있도록 한다.
 *
...
public final class StockEventUuidDeriver {
     ...
     * @param prefix    이벤트 구분 접두사 (예: "stock-commit")
