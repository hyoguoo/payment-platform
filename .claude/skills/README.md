...
| `wiki-access` | `<project>.wiki/` 별도 git 저장소 자동 탐색 + Read/Grep/Edit 접근 ("위키 참고" / "깃헙 위키" 트리거) |
...
| `doc-review-round.md` | 문서 검수 4관점 루프 (규격·서사·기술·독자) |

### `_shared/references/` — 공용 레퍼런스
스킬이 참조하는 공통 자료.

| 파일 | 용도 |
|---|---|
| `writing.md` | 문서 작성 컨벤션 (문체, 표, 구조, 팩트 검증) |
...
| `architect.md` | Fable | discuss, plan (설계/주석 개입) |
...
| `domain-expert.md` | Fable | discuss, plan, code(조건부) (결제 도메인 리스크) |
