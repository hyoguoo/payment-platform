...
작성 컨벤션은 `.claude/skills/_shared/conventions/writing-style.md`(문체) · `writing-terminology.md`(용어·식별자) · `writing-visuals.md`(표·다이어그램)에 정의되어 있다.

---

## 컨벤션 요약

작성 전 반드시 `.claude/skills/_shared/conventions/writing-style.md` / `writing-terminology.md` / `writing-visuals.md` 세 파일을 읽고 전체 규칙을 숙지한다.
핵심 규칙만 요약하면 아래와 같다.
