...
작성 컨벤션은 `.claude/skills/_shared/conventions/writing-style.md`(문체) · `writing-terminology.md`(용어·식별자) · `writing-visuals.md`(표·다이어그램)에 정의되어 있다. 작성 전 반드시 세 파일을 읽고 전체 규칙을 숙지한다 — 정본은 그 세 파일이고, 여기에는 요약 사본을 두지 않는다.
