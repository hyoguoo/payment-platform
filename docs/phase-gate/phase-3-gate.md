...
- **product→payment Redis SET**: T3-04 PaymentRedisStockAdapter — 단위 테스트 커버 확인
...
- 복귀 태스크: **T3-04** (StockCommitConsumer + PaymentRedisStockAdapter)
- 조치:
  ```bash
...
- 복귀 태스크: **T3-04** (PaymentRedisStockAdapter + StockCommitUseCase 원자성)
