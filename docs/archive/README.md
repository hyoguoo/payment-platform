...
| `phase-4-readiness-sweep/` | Phase 4 진입 전 self-loop 정리 — 잔재 워크플로우 식별자(T*/K*/D*/S*/TC-K*) · ADR 키워드 · 폐기 클래스명(StockRestore/StockSnapshot/FailureCompensation) 코드/문서 전수 제거, EventType enum dead 12건 정리, dead config / V1 dead column 제거, PaymentEvent.resetToReady invariant 테스트 9건 추가 | 2026-04-27 |
