...
> 최종 수정: 2026-05-11 — CBA-6 완료 (PaymentExceptionHandler 핸들러 2건 추가 — 503 + Retry-After:5, payment-service 379 PASS). 활성 태스크 CBA-8.

## 활성 작업

- **주제**: CLEANUP-BATCH-A (코드 청소 4건 묶음 — TC-16 + TC-10 + TC-2 + TC-5)
- **단계**: execute (활성 태스크 CBA-8 — PgInbox 도메인 builder 전환 + factory 본문 갈아끼움, §1.2 TC-10)
