...
| **Phase 6** | **MSA 전환 및 분산 환경 고도화** | [MSA 전환](https://github.com/hyoguoo/payment-platform/wiki/msa-transition) · [이벤트 드리븐 코레오그래피](https://github.com/hyoguoo/payment-platform/wiki/event-driven-choreography) · [재고 캐시 보상 회복 — Lua atomic](https://github.com/hyoguoo/payment-platform/wiki/stock-cache-recovery) · [재고 선차감 게이트 상품 단위 분해](https://github.com/hyoguoo/payment-platform/wiki/stock-gate-per-product) · [Outbox 패턴](https://github.com/hyoguoo/payment-platform/wiki/outbox-pattern) · [메시지 전달 보장 + dedupe](https://github.com/hyoguoo/payment-platform/wiki/message-delivery-and-dedupe) · [결제 복구 모델](https://github.com/hyoguoo/payment-platform/wiki/payment-recovery-model) · [PG 결제 확인 흐름](https://github.com/hyoguoo/payment-platform/wiki/pg-confirm-flow) · [분산 트레이싱](https://github.com/hyoguoo/payment-platform/wiki/trace-propagation) |
...
> Phase 6 에서 상태가 하나 늘었다 — 복구 스케줄러가 되돌리는 자리가 대기에서 **결과 대기**로 바뀌어 뒤늦게 도착한 승인을 그대로 적용한다 ([결제 복구 모델](https://github.com/hyoguoo/payment-platform/wiki/payment-recovery-model))
