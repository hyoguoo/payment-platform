...
/**
 * {@code stock_commit_dedupe} 만료 행 청소 스케줄러.
 *
 * <p>D-CLEAN-2/4 구현체. {@link EventDedupeStore#deleteExpired(Instant, int)} 를 주기적으로 호출해
...
public class DedupeCleanupWorker {
    ...
    private void deleteExpiredBatch(Instant now) {
        ...
        LogFmt.info(log, LogDomain.STOCK, EventType.EVENT_DEDUPE_CLEANUP,
