...
run_outbox "outbox-parallel-low" "true"  "100" "300"
...
run_outbox "outbox-parallel-high" "true"  "800" "1500"
...
echo ""
print_info "결과: scripts/k6/results/{sync,outbox,outbox-parallel}-{low,high}.json"
