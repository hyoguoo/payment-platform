...
class OrderFacadeServiceTest {
    ...
    void getOrderDetailsByIdAndUpdatePaymentInfo() {
        ...
        // When
        OrderFindDetailResponse result = orderFacadeService.getOrderDetailsByIdAndUpdatePaymentInfo(orderId);
    ...
    void testCreateOrder() {
        ...
        when(orderService.saveOrderInfo(any())).thenReturn(generateOrderInfoWithTotalAmountAndQuantity(1L, DEFAULT_USER, DEFAULT_PRODUCT, DEFAULT_TOTAL_AMOUNT, DEFAULT_QUANTITY));
    ...
    void testCancelOrder() {
        ...
        when(orderService.getOrderInfoByOrderId(orderCancelRequest.getOrderId())).thenReturn(orderInfo);
