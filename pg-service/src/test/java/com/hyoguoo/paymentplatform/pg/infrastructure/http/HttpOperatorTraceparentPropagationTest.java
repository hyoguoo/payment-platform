...
/**
 * HttpOperatorImpl(pg-service) Builder 주입 구조 검증.
 *
 * <p>Spring Boot 3.2+ 는 {@code RestClient.Builder} auto-config 에서 {@code ObservationRegistry} 를
 ...
 */
@DisplayName("HttpOperatorImpl(pg-service) Builder 주입 구조 검증")
